...
function Pages(){
    return(
        ...
        <div className="div  text-slate-100  flex md:flex-row flex-col gap-10 md:justify-center md:text-left text-center "> 
            <div className="div1 md:p-7 bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl drop-shadow-md md:w-1/2 w-5/6  mx-auto ">
            ...
            <div className="div1 md:p-7 relative md:top-16 bg-gradient-to-b from-slate-900 to-slate-950 rounded-2xl drop-shadow-md md:w-1/2 w-5/6 mx-auto">
