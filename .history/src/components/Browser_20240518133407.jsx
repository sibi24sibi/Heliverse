...
function Browser(){
    return(
        <>
        <section className='BROWSER flex text-center justify-center w-fit h-fit bg-[#0F0920] rounded-xl my-16 max-w-6xl '>

            <div className="div text-slate-100 p-10 px-10 md:p-16  md:px-64">
