    ...
    return(
        ...
        <section className='FEATURE flex text-center justify-center '>
            ...
            <div className="div text-slate-100 ">
                ...
                <p className='font-bold text-3xl text-center '>An All-Round Plugin With Powerful Features</p>
                <p className='text-center '>Whether you're a seasoned web designer or just starting out, Motion Art for Elementor seamlessly integrates with the Elementor platform, providing you with a seamless and intuitive experience.</p>
                </div>
