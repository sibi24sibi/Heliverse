...
function Purchase(){
    return(
        ...
        <section className='Purchase flex md:flex-row flex-col md:text-left text-center md:justify-between max-w-6xl px-8'>
            ...
            <button className='p-10 px-8  rounded-lg  flex bg-gradient-to-r from-[#F87516] from-10% to-[#5E11FF] to-90%  text-slate-200 '>
                 <p>Purchase here  </p><span className='ml-5'> ► </span>
            </button>
            </div>
