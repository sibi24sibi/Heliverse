    ...
    return(
        ...
        <section className='Purchase flex md:flex-row flex-col md:text-left text-center md:justify-between max-w-6xl px-8'>
            <div className="text-and-btn text-slate-100">
                <h1 className='text-2xl mb-7'>Turn Your Cursor Into A Colorful Magic Wand & Charm Your Visitors.</h1>
            ...
            <button className='p-3 px-8  rounded-lg  bg-gradient-to-r from-[#F87516] from-10% to-[#5E11FF] to-90%  text-slate-200 '>
                 Purchase here
            </button>
            </div>
