        ...
        <>
            <section className='Purchase flex md:flex-row flex-col md:text-left text-center md:justify-between max-w-6xl px-8'>
                <div className="text-and-btn text-slate-100">
                    ...
                    <button className='p-3 px-8 md:p-6 md:px-20 flex rounded-lg  bg-gradient-to-r from-[#F87516] from-10% to-[#5E11FF] to-90%  text-slate-200 '>
                        <p>Purchase From Evanto </p> <p className='ml-5'>►</p>
                    </button>
                </div>
