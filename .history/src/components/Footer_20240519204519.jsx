...
function Footer(){
    return(
        <>
        <section className='FOOTER text-neutral-100 flex md:flex-row  flex-col-reverse  md:justify-between  bg-gradient-to-r from-[#F87516] from-30% to-[#5E11FF] to-40% min-w-full p-3 '>
