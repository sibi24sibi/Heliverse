...
function Sponser(){
    return(
        ...
        <section className='SPONSER text-slate-100 m-6  max-w-6xl'>
            <h1 className=" text-center text-base md:text-3xl m-10">Trusted by thousands of users around the world</h1>  
            <div className="div flex md:flex-row flex-col  justify-around md:gap-36 gap-6">
