...
function Pages(){
    return(
        ...
        <div className="div  text-slate-100  flex md:flex-row flex-col gap-10 md:justify-center content-center "> 
            <div className="div1 md:p-7 bg-[#0F0920] rounded-2xl drop-shadow-md md:w-1/2 w-5/6">
            ...
            <div className="div1 md:p-7 bg-[#0F0920] rounded-2xl drop-shadow-md md:w-1/2 w-full ">
